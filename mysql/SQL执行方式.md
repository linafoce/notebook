[MySQL的内部组件结构](#4288-1594188583718)

[Server层](#6274-1594188634239)

[Store层](#9060-1594188653357)

[连接器](#6240-1594192782654)

[分析器](#9745-1594192484021)

[词法分析器原理](#9549-1594193938143)

[优化器](#8317-1594194778150)

[执行器](#5677-1594195086987)

[bin-log归档](#8966-1594195608590)

**MySQL的内部组件结构**

![image-20210128163409234](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210128163409234.png)
...
![img](https:////note.youdao.com/src/ABFF150C72B14146950B62F154D6CCD9)
...
![img](https:////note.youdao.com/src/A7B130C7D7A84518B9B0B2D890FEED8C)
...
![img](https:////note.youdao.com/src/B9D83EB8AFBC4446BBA64ED293927067)
...
![img](https:////note.youdao.com/src/A34201ADDAB740368F51A29313A3F55E)
...
![img](https:////note.youdao.com/src/5C4B5E1FFB344BD3B0F34C45E2EE133C)
...
![img](https:////note.youdao.com/src/363B9FBC8A3545F08F02C9231983B1E9)
...
配置开启binlog log-bin=/usr/local/mysql/data/binlog/mysql-bin 注意5.7以及更高版本需要配置本项：server-id=123454（自定义,保证唯一性）; #binlog格式，有3种statement,row,mixed binlog-format=ROW #表示每1次执行写入就与硬盘同步，会影响性能，为0时表示，事务提交时mysql不做刷盘操作，由系统决定 sync-binlog=1
...
![img](https:////note.youdao.com/src/61CC7E0C222A4FFBA8BAB8512E621B86)
