[什么是JMM模型？](#6898-1595742675955)

[JMM不同于JVM内存区域模型](#3859-1561016857893)

[工作内存](#8854-1561017140900)

[Java内存模型与硬件内存架构的关系](#8948-1561282030941)

[JMM存在的必要性](#3035-1561288510377)

[数据同步八大原子操作](#8025-1561379646865)

[同步规则分析](#8924-1561298218320)

[并发编程的可见性，原子性与有序性问题](#7897-1561384063642)

[原子性](#5289-1561384719469)

[可见性](#4022-1561385380326)

[有序性](#6370-1561385435157)

[JMM如何解决原子性&可见性&有序性问题](#5356-1561386713191)

[原子性问题](#8054-1561385875245)

[可见性问题](#9765-1561386526258)

[有序性问题](#7614-1561461998951)

[as-if-serial语义](#2320-1561468212680)

[happens-before 原则](#8942-1561386775777)

[volatile内存语义](#3847-1561469455218)

[volatile的可见性](#4700-1561469854873)

[volatile无法保证原子性](#9143-1561472000146)

[volatile禁止重排优化](#4682-1561472412982)

[硬件层的内存屏障](#4680-1596609657820)

[volatile内存语义的实现](#7935-1561472227965)
...
![image-20210222234728504](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210222234728504.png)
...
![image-20210316092135155](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316092135155.png)

**Java内存模型与硬件内存架构的关系**

通过对前面的硬件内存架构、Java内存模型以及Java多线程的实现原理的了解，我们应该已经意识到，多线程的执行最终都会映射到硬件处理器上进行执行，但Java内存模型和硬件内存架构并不完全一致。对于硬件内存来说只有寄存器、缓存内存、主内存的概念，并没有工作内存(线程私有数据区域)和主内存(堆内存)之分，也就是说Java内存模型对内存的划分对硬件内存并没有任何影响，因为JMM只是一种抽象的概念，是一组规则，并不实际存在，不管是工作内存的数据还是主内存的数据，对于计算机硬件来说都会存储在计算机主内存中，当然也有可能存储到CPU缓存或者寄存器中，因此总体上来说，Java内存模型和计算机硬件内存架构是一个相互交叉的关系，是一种抽象概念划分与真实物理硬件的交叉。(注意对于Java内存区域划分也是同样的道理)

![image-20210316092234096](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316092234096.png)
...
![image-20210316092301059](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316092301059.png)
...
![image-20210316092714183](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316092714183.png)
...
![image-20210316092953165](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316092953165.png)
...
![image-20210316105832381](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316105832381.png)
...
![image-20210316105853723](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316105853723.png)
...
![image-20210316110002529](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316110002529.png)
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (; ; ) {
            ...
            Thread t1 = new Thread(() -> {
                ...
                a = 1;
                x = b;
                // Unsafe类时java一个特殊的类，可以通过这个类加内存屏障
