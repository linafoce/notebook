[设计同步器的意义](#5997-1595244427217)

[如何解决线程并发安全问题？](#5628-1562503702068)

[synchronized原理详解](#2024-1562503886225)

[synchronized底层原理](#4113-1562504328107)

[Monitor监视器锁](#8934-1595236134661)

[什么是monitor？](#1364-1595236512122)

[对象的内存布局](#1000-1562505126980)

[对象头](#3019-1562505416952)

[对象头分析工具](#1271-1595237203625)

[锁的膨胀升级过程](#7811-1595244313184)

[偏向锁](#5088-1562506257763)

[轻量级锁](#6830-1562506294187)

[自旋锁](#2196-1562506294187)

[锁消除](#6046-1562506294187)

[逃逸分析](#5995-1564129051947)
...
public class Juc_LockOnThisObject {
    ...
    public static void main(String[] args) {
        Juc_LockOnThisObject thisObject = new Juc_LockOnThisObject();
        thisObject.decrStock();
    }
}
```
...
![image-20210316142719195](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316142719195.png)

每个同步对象都有一个自己的Monitor(监视器锁)，加锁过程如下图所示：

![image-20210316142855763](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316142855763.png)
...
![image-20210316143611158](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316143611158.png)
...
![image-20210316145516643](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316145516643.png)
...
![image-20210316150354559](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316150354559.png)

64位虚拟机

![image-20210316150415891](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316150415891.png)
...
![image-20210316150542075](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210316150542075.png)
...
![image-20210320204546465](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210320204546465.png)

![image-20210320205241649](/Users/xiangtingwei/Library/Application Support/typora-user-images/image-20210320205241649.png)